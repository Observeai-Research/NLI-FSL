...
def parse_argument():
	...
	parser.add_argument('--fasttext_path',type=str, default='../fasttext/crawl-300d-2M.vec')
...
if __name__ == "__main__": 
	...
	for n_r in range(num_run): 
		...
		data = read_datasets(config["inter_data_path"], config['num_samples_per_class'], config['dataset'], n_r + 1, config['src'], config['tgt'], config['fasttext_path'])
